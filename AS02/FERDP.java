...
///////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   public static boolean recognize() {
      ...
      System.out.println("Tokens expected: " + n);
      System.out.println("Tokens recognized: " + recognized);
      return (recognized == n);      
   }
...
///////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   public static int NL(int startIndex) {
      int result = 0;
      if(token[startIndex] == TOKEN_NL) { result = 1; }
      return result;
   }
